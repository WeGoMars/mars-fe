    ...
    <div className="min-h-screen bg-[#f5f7f9]">
      ...
      <header className="flex items-center justify-between p-2 bg-white border-b h-14">
        <div className="flex items-center gap-2">
          ...
          <img src="/assets/orange-planet.png" alt="Mars 로고" width={32} height={32} className="rounded-full" />
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button className="bg-[#006ffd] text-white px-3 py-1.5 rounded-md text-sm">로그아웃</button>
        </div>
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8">
                    ...
                    {stock.symbol === "GOOGL" && (
                      <img src="/assets/google-logo.png" alt="Google" width={32} height={32} />
                    )}
                    {stock.symbol === "SPOT" && (
                      <img src="/assets/spotify-logo.png" alt="Spotify" width={32} height={32} />
                    )}
                  </div>
                  <div>
        ...
        <div className="w-full lg:w-80 flex flex-col mt-4 lg:mt-0">
          ...
          <div className="bg-white rounded-xl p-4 md:p-5 shadow-sm flex-1 overflow-auto flex flex-col">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div>
                <div className="font-bold text-right">$213.10</div>
                <div className="text-xs text-[#41c3a9] text-right">↑ 1.1%</div>
              </div>
            </div>
