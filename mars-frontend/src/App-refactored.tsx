...
function App() {
  const { stocks, isLoading, error, selectedStock, selectStock } = useStockData()
      ...
      <div className="flex flex-col lg:flex-row p-4 gap-4">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm flex-1 overflow-auto">
            ...
            {/* Chart Area */}
            {selectedStock && <StockChart symbol={selectedStock} period={activePeriod} />}
        ...
        <div className="w-full lg:w-80 flex flex-col mt-4 lg:mt-0">
          ...
          <div className="bg-white rounded-xl p-4 md:p-5 shadow-sm flex-1 overflow-auto flex flex-col">
            {selectedStock && (
              <StockDetails symbol={selectedStock} activeTab={activeRightTab} onTabChange={setActiveRightTab} />
            )}
          </div>
        </div>
      </div>
